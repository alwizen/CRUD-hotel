...
<div class="container">
   ...
   $detail = mysql_query("SELECT tamu.id, tamu.nama, tamu.jns_kel, tamu.notelp, tamu.jalan, tamu.kota, tamu.provinsi, tamu.kd_pos, tamu.tgl_checkin, tamu.tgl_checkout, tamu.keterangan, kamar.no_kamar, kamar.tipe_kamar, kamar.jml_ranjang from tamu,kamar where tamu.id='$id_tm' LIMIT 1") or die(mysql_errno());
    while ($data=mysql_fetch_array($detail)){ //mengambil data
    ?>
    <div class="row">
      <div class="col-md-12">
